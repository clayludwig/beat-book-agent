...
def run_pipeline(stories: List[dict], openai_api_key: str,
    ...
    vectors = _load_or_embed(client, texts)
    ...
    broad_map = _label_all(client, stories, broad_labels, reduced, "broad",
                           lambda s, f, d: _p("labeling", f * 0.4, d))
    spec_map  = _label_all(client, stories, spec_labels,  reduced, "specific",
